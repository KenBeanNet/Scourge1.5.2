...
public class ItemAgilityArmor extends ItemArmor implements ISpecialArmor {
	
	//myArmorLevel determines the Tier of the armor;
	
	private int myArmorLevel;
	public ItemAgilityArmor(int par1, EnumArmorMaterial par2EnumArmorMaterial,
	 ...
	 switch (myArmorLevel) //Tier 0
		{
			...
			{
				if (slot == 2)
			 		return "/mods/scourgecraft/textures/models/agilityArmorLegs.png";
		        return "/mods/scourgecraft/textures/models/agilityArmor.png";
			}
			case 1:
			{
				if (slot == 2)
			 		return "/mods/scourgecraft/textures/models/agilityArmorLegsT1.png";
