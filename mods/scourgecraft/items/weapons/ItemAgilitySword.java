...
public class ItemAgilitySword extends ItemScourgeSword
{
	private Random random = new Random();

    public ItemAgilitySword(int var1, EnumToolMaterial var2, int level)
    {
    	super(var1, var2);
        this.maxStackSize = 1;
        this.myLevel = level;
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
    {
		...
		par3List.add("Ability : Speed Increase");
