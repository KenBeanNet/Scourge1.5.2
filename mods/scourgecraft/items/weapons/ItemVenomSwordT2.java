...
public class ItemVenomSwordT2 extends ItemSword
{
	private Random rand = new Random();
    private int weaponDamage;
    private final EnumToolMaterial field_40439_b;

    public ItemVenomSwordT2(int var1, EnumToolMaterial var2)
    {
        super(var1, var2);
    ...
    public boolean hitEntity(ItemStack var1, EntityLiving var2, EntityLiving var3)
    {
    	...
    	if (this.rand.nextInt(10) <= 3)
    	{
    		var2.addPotionEffect(new PotionEffect(Potion.hunger.id, 60, 0));
    	}
