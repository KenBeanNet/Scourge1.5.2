...
public class RenderPlaguedWarrior extends RenderLiving
{
    protected ModelPlaguedWarrior modelBipedMain;
    protected float field_77070_b;

    public RenderPlaguedWarrior(ModelPlaguedWarrior var1, float var2)
    {
        this(var1, var2, 1.0F);
        this.modelBipedMain = var1;
    }

    public RenderPlaguedWarrior(ModelPlaguedWarrior var1, float var2, float var3)
    {
        super(var1, var2);
        this.modelBipedMain = var1;
