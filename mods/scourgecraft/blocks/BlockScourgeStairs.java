...
public class BlockScourgeStairs extends BlockStairs
{
    private Block modelBlock;

    public BlockScourgeStairs(int var1, Block var2, int var3)
    {
    ...
    public void onBlockPlacedBy(World var1, int var2, int var3, int var4, EntityLiving var5)
    {
        ...
        if (var6 == 0)
        {
            var1.setBlock(var2, var3, var4, 2 | var7);
        }

        if (var6 == 1)
        {
            var1.setBlock(var2, var3, var4, 1 | var7);
        }

        if (var6 == 2)
        {
            var1.setBlock(var2, var3, var4, 3 | var7);
        }

        if (var6 == 3)
        {
            var1.setBlock(var2, var3, var4, 0 | var7);
        }
    }
    ...
    public void onBlockPlaced(World var1, int var2, int var3, int var4, int var5)
    {
        if (var5 == 0)
        {
            ...
            var1.setBlock(var2, var3, var4, var6 | 4);
        }
    }
