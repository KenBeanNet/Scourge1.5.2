...
public class RenderPlaguedArcher extends RenderLiving
{
    protected ModelPlaguedArcher modelBipedMain;
    protected float field_77070_b;

    public RenderPlaguedArcher(ModelPlaguedArcher var1, float var2)
    {
        this(var1, var2, 1.0F);
        this.modelBipedMain = var1;
    }

    public RenderPlaguedArcher(ModelPlaguedArcher var1, float var2, float var3)
    {
        super(var1, var2);
        this.modelBipedMain = var1;
