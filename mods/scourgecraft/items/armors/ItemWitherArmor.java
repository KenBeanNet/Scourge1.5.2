...
public class ItemWitherArmor extends ItemArmor implements ISpecialArmor {
	
	//myArmorLevel determines the Tier of the armor;
	
	private int myArmorLevel;
	public ItemWitherArmor(int par1, EnumArmorMaterial par2EnumArmorMaterial,
	 ...
	 switch (myArmorLevel) //Tier 0
		{
			...
			{
				if (slot == 2)
			 		return "/mods/scourgecraft/textures/models/witherArmorLegs.png";
		        return "/mods/scourgecraft/textures/models/witherArmor.png";
			}
			case 1:
			{
			 	if (slot == 2)
			 		return "/mods/scourgecraft/textures/models/witherArmorLegsT1.png";
		        return "/mods/scourgecraft/textures/models/witherArmorT1.png";
			}
			case 2:
			{
				break;
