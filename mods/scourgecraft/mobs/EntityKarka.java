...
public class EntityKarka extends EntityMob
{
    ...
    {
        return this.worldObj.difficultySetting > 0 && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).size() == 0 && !this.worldObj.isAnyLiquid(this.boundingBox);
    }
