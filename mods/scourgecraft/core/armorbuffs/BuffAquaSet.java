...
public class BuffAquaSet implements IBuffHandler {
	private int myLevel = 0;
	public BuffAquaSet(int armorLevel)
	{
		myLevel = armorLevel;
	}
    @Override
    	...
    	switch(myLevel)
    	{
    		...
    		case 1:
    		{
    	    	if (itemCount >= 3)
    	    	{
    	    		...
    	    		if (itemCount == 4)
    	    		{
    	    			player.addPotionEffect(new PotionEffect(ScourgeCraftCore.configPotion.aquaLegs.id, 40));
    	    		}
    	    	}
    	    	break;
    		}
