...
public class ModRecipes {
	...
	public static void init()
    {
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ScourgeCraftCore.configItems.infernalGem, 9), new Object[] {ScourgeCraftCore.configItems.infernalOrb}));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ScourgeCraftCore.configItems.aquaGem, 9), new Object[] {ScourgeCraftCore.configItems.aquaOrb}));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ScourgeCraftCore.configItems.plagueGem, 9), new Object[] {ScourgeCraftCore.configItems.plagueOrb}));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ScourgeCraftCore.configItems.witherGem, 9), new Object[] {ScourgeCraftCore.configItems.witherOrb}));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ScourgeCraftCore.configItems.agilityGem, 9), new Object[] {ScourgeCraftCore.configItems.agilityOrb}));
		...
		//T1 Weapons
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.venomSwordT1, 1), new Object[] {"xox", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.venomGem, 'o', ScourgeCraftCore.configItems.venomOrb, 's', ScourgeCraftCore.configItems.venomWeaponT1Schematic, 'z', ScourgeCraftCore.configItems.venomSword});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.infernalSwordT1, 1), new Object[] {"xox", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.infernalGem, 'o', ScourgeCraftCore.configItems.infernalOrb, 's', ScourgeCraftCore.configItems.infernalWeaponT1Schematic, 'z', ScourgeCraftCore.configItems.infernalSword});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.aquaSwordT1, 1), new Object[] {"xox", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.aquaGem, 'o', ScourgeCraftCore.configItems.aquaOrb, 's', ScourgeCraftCore.configItems.aquaWeaponT1Schematic, 'z', ScourgeCraftCore.configItems.aquaSword});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.plagueSwordT1, 1), new Object[] {"xox", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.plagueGem, 'o', ScourgeCraftCore.configItems.plagueOrb, 's', ScourgeCraftCore.configItems.plagueWeaponT1Schematic, 'z', ScourgeCraftCore.configItems.plagueSword});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.witherSwordT1, 1), new Object[] {"xox", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.witherGem, 'o', ScourgeCraftCore.configItems.witherOrb, 's', ScourgeCraftCore.configItems.witherWeaponT1Schematic, 'z', ScourgeCraftCore.configItems.witherSword});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.agilitySwordT1, 1), new Object[] {"xox", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.agilityGem, 'o', ScourgeCraftCore.configItems.agilityOrb, 's', ScourgeCraftCore.configItems.agilityWeaponT1Schematic, 'z', ScourgeCraftCore.configItems.agilitySword});
		
		//T2 Weapons
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.venomSwordT2, 1), new Object[] {"ooo", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.venomGem, 'o', ScourgeCraftCore.configItems.venomOrb, 's', ScourgeCraftCore.configItems.venomWeaponT2Schematic, 'z', ScourgeCraftCore.configItems.venomSwordT1});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.infernalSwordT2, 1), new Object[] {"ooo", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.infernalGem, 'o', ScourgeCraftCore.configItems.infernalOrb, 's', ScourgeCraftCore.configItems.infernalWeaponT2Schematic, 'z', ScourgeCraftCore.configItems.infernalSwordT1});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.aquaSwordT2, 1), new Object[] {"ooo", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.aquaGem, 'o', ScourgeCraftCore.configItems.aquaOrb, 's', ScourgeCraftCore.configItems.aquaWeaponT2Schematic, 'z', ScourgeCraftCore.configItems.aquaSwordT1});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.plagueSwordT2, 1), new Object[] {"ooo", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.plagueGem, 'o', ScourgeCraftCore.configItems.plagueOrb, 's', ScourgeCraftCore.configItems.plagueWeaponT2Schematic, 'z', ScourgeCraftCore.configItems.plagueSwordT1});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.witherSwordT2, 1), new Object[] {"ooo", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.witherGem, 'o', ScourgeCraftCore.configItems.witherOrb, 's', ScourgeCraftCore.configItems.witherWeaponT2Schematic, 'z', ScourgeCraftCore.configItems.witherSwordT1});
		GameRegistry.addRecipe(new ItemStack(ScourgeCraftCore.configItems.agilitySwordT2, 1), new Object[] {"ooo", "xzx", "xsx", 'x', ScourgeCraftCore.configItems.agilityGem, 'o', ScourgeCraftCore.configItems.agilityOrb, 's', ScourgeCraftCore.configItems.agilityWeaponT2Schematic, 'z', ScourgeCraftCore.configItems.agilitySwordT1});
